...
<h3 class="join_title_main">REVIEW</h3><br>
<hr class="community_hr">
<div>
	<form action="/board/reviewwrite_insert" method="post" id="frm">
	...
	<div>
		...
		<input class="qna_w_btn2" type="button" value="취소" onclick="history.back()">
	</div>
	</form>
</div>
